...
document.write("Name:" + camera.name + "<br>");
document.write("Product Description:" + camera.product_description + "<br>");
document.write("Delivery by:" + camera.delivery_by + "<br>");
document.write("Sold by:" + camera.sold_by + "<br>");
document.write("Price: " + camera.price + "<br>");
document.write("Warranty details: " + camera.warranty_details + "<br>");