...
document.write("Name:" + phone.name + "<br>");
document.write("Product Description:" + phone.product_description + "<br>");
document.write("Sold by:" + phone.sold_by + "<br>");
document.write("Price: " + phone.price + "<br>");
document.write("Warranty details: " + phone.warranty_details + "<br>");