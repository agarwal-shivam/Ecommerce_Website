...
output1.innerHTML="Name:"+phone.name;
output1.innerHTML="Product Description"+phone.product_description;
output1.innerHTML="Delivery by:"+phone.delivery_by;
output1.innerHTML="Sold by:"+phone.sold_by;
output1.innerHTML="Price"+phone.price;
output1.innerHTML="Warranty details"+phone.warranty_details;
...
output2.innerHTML="Name:"+camera.name;
output2.innerHTML="Product Description:"+camera.product_description;
output2.innerHTML="Delivery by:"+camera.delivery_by;
output2.innerHTML="Sold by:"+camera.sold_by;
output2.innerHTML="Price:"+camera.price;
output2.innerHTML="Warranty details:"+camera.warranty_details;
